...
namespace ShipWebServiceClient
{
    class Program
    {
        ...
        private static WebAuthenticationDetail SetWebAuthenticationDetail()
        {
            ...
            wad.UserCredential.Key = "WdO6uydPOQ9U5LxW"; // Replace "XXX" with the Key
            wad.UserCredential.Password = "nmDZwmmAzg2wXq66utbNG7PFf"; // Replace "XXX" with the Password
            wad.ParentCredential = new WebAuthenticationCredential();
            wad.ParentCredential.Key = "WdO6uydPOQ9U5LxW"; // Replace "XXX" with the Key
            wad.ParentCredential.Password = "nmDZwmmAzg2wXq66utbNG7PFf"; // Replace "XXX"
        ...
        private static void SetShipmentDetails(ProcessShipmentRequest request, bool isChild, ProcessShipmentReply masterReply)
        {
            ...
            request.RequestedShipment.ServiceType = "PRIORITY_OVERNIGHT"; // Service types are STANDARD_OVERNIGHT, PRIORITY_OVERNIGHT, FEDEX_GROUND ...
