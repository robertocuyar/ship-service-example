...
namespace ShipWebServiceClient
{
    class Program
    {
        ...
        private static void SetShipmentDetails(ProcessShipmentRequest request)
        {
            ...
            request.RequestedShipment.ServiceType = "INTERNATIONAL_ECONOMY_FREIGHT";// "FEDEX_FREIGHT_PRIORITY"; // Service types are STANDARD_OVERNIGHT, PRIORITY_OVERNIGHT, ...
            ...
            SetPayment(request);
            //
            SetExpressFreightDetail(request);
            ...
            SetPackageLineItem(request);
                    

        }

        private static void SetExpressFreightDetail(ProcessShipmentRequest request)
        {
            request.RequestedShipment.ExpressFreightDetail = new ExpressFreightDetail();
            request.RequestedShipment.ExpressFreightDetail.PackingListEnclosed = true;
            request.RequestedShipment.ExpressFreightDetail.PackingListEnclosedSpecified = true;
            request.RequestedShipment.ExpressFreightDetail.ShippersLoadAndCount = "2";
            request.RequestedShipment.ExpressFreightDetail.BookingConfirmationNumber = "123asd789";
        ...
        private static void SetRecipient(ProcessShipmentRequest request)
        {
            ...
            request.RequestedShipment.Recipient.Address.PostalCode = "V7C4v7";
        ...
        private static void SetFreightShipmentDetail(ProcessShipmentRequest request)
        {
            ...
            request.RequestedShipment.FreightShipmentDetail.TotalHandlingUnits = "1";
        ...
        private static void SetPackageLineItem(ProcessShipmentRequest request)
        {
            ...
            request.RequestedShipment.RequestedPackageLineItems[0].Weight.Value = 5.0M;
            request.RequestedShipment.RequestedPackageLineItems[0].Weight.Units = WeightUnits.LB;
            //
            request.RequestedShipment.RequestedPackageLineItems[0].ItemDescription = "Description of Item";
            ...
            request.RequestedShipment.RequestedPackageLineItems[0].Dimensions.Width = "50";
