...
namespace ShipWebServiceClient
{
    class Program
    {
        ...
        private static void SetShipmentDetails(ProcessShipmentRequest request)
        {
            ...
            request.RequestedShipment.ServiceType = "FEDEX_GROUND"; // Service types are FEDEX_GROUND, GROUND_HOME_DELIVERY ...
        ...
        private static void SetHAL(ProcessShipmentRequest request)
        {
            ...
            request.RequestedShipment.SpecialServicesRequested.SpecialServiceTypes[0] = "HOLD_AT_LOCATION";
            //
